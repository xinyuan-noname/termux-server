...
async function start() {
    ...
    try {
        ...
        app.use(cors({
            origin: [process.env.APP_WEB_URL, process.env.APP_WEB_URL_BACKUP,"https://shine-web.xinyuan-noname.deno.net"],
        ...
        app.get("/resource/main/:a/:b", createRateLimiter(1, 30), (req, res) => {
            const { a, b } = req.params;
            const url = `https://gh.llkk.cc/https://raw.githubusercontent.com/xinyuan-noname/resource/main/${a}/${b}`;
        ...
        const taskDrawRoutes = require('./routes/task_draw.routes');
        app.use('/task/draw', taskDrawRoutes);
        const taskVoteRoutes = require('./routes/task_vote.routes');
        app.use('/task/vote', taskVoteRoutes);
